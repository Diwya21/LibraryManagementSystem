...
class Book {
    ...
    public Book(String topic, String authorofbook, String isbno) {
        this.topic = topic;
    ...
    public String toString() {
        return "Title: " + topic + ", Author: " + authorofbook + ", ISBN: " + isbno + ", Available: " + isAvailable;
    }
}
...
class Library {
    ...
    public Book borrowBook(String isbno) {
        for (Book book : books) {
            if (book.getIsbn().equals(isbno) && book.isAvailable()) {
                book.setAvailable(false);
                return book;
            }
        }
        return null; // Book not found or not available at this time
    }
...
class FictionBook extends Book {
    ...
    public FictionBook(String topic, String authorofbook, String isbno, String genre) {
        super(topic, authorofbook, isbno);
        this.genre = genre;
    }
...
class NonFictionBook extends Book {
    ...
    public NonFictionBook(String topic, String authorofbook, String isbno, String subject) {
        super(topic, authorofbook, isbno);
...
public class LibraryManagementSystem {
    public static void main(String[] args) {
        ...
        // Adding sample books
        library.addBook(new FictionBook("Senkottan", "Mahinda Prasad", "15160", "Fantasy"));
        library.addBook(new NonFictionBook("Ape Kurullo", "Seetha De Seram", "15161", "Adventure"));
        library.addBook(new FictionBook("Yuganthaya", "Martin Wickramasinghe", "15162", "Historical "));
        ...
        do {
			...
			switch (choice) {
                ...
                case 2:
                    ...
                    scanner.nextLine(); // Apply the newline character.
                ...
                case 3:
                    if (user.getBorrowedBooks().isEmpty()) {
                        ...
                        scanner.nextLine(); //Take in the newline character.
